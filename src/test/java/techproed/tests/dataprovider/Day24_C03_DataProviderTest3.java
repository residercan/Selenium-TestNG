...
public class Day24_C03_DataProviderTest3 {


    //    DATA PRIVIDER METOTU
    //    EXCEL DATALARI-> DATA PROVIDER -> TEST METHODLARI
    //    MÜŞTERİ BİLGİLERİ TEST 2'DE HARD CODE ŞEKLİNDE YAZILMIŞTIR
    //    BURADA İSE MÜŞTERİ BİLGİLERİNİ EXCEL DOSYASINDAN ÇEKECEĞİZ.
    //    BU KULLANIM DİNAMİK CODE'DUR.
    @DataProvider
